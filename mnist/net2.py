...
class Mnist(DnnNet):
    def __init__(self, batch_size: int):
        ...
        # ################### layers 2 (conv2)################################################
        self.conv2, self.conv2_out = clayers.conv2d('conv2', self.pooling1_out, (50, 20, 5, 5), 1, 'SAME')
        ...
        # ################### layers 3 (fc3)####################################################
        self.fc3, self.fc3_out = clayers.full_connect('fc3', self.pooling2_out, 500)
        ...
        self.loss, self.loss_out = closses.softmax_withloss('loss', self.fc4_out, self.label)

        self.copt = coptimizers.adam(learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8)
